...
MADS is a [Multi-Agent Distributed System](https://mads-net.github.io/presentations/intro.html): a multi-platform framework of tools and libraries to coordinate a bunch of agents that exchange information through ZeroMQ protocol. MADS is **plugin-based**, and also has a Python interface.
